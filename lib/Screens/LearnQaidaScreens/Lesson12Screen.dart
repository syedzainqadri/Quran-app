...
import 'package:quranapp/controllers/lesson12_controller.dart';
...
class Lesson12Screen extends StatefulWidget {
  ...
  const Lesson12Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson12ScreenState extends State<Lesson12Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson12Controller());
    sounds = FirebaseApi.listAll('sound12/');
    files = FirebaseApi.listAll('text12/');
    instructions = FirebaseApi.listAll('instruction12/');
  ...
  @override
  void dispose() {
    Get.find<Lesson12Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 5,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction12%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text12%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                    ...
                                    word:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text12%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    soundPath:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound12%2FL12%20${index + 1}.wav?alt=media&token=48076475-9d3a-403f-8d63-c7e407fc6479");
                              },
                              childCount: 91,
                            ),
                            gridDelegate:
