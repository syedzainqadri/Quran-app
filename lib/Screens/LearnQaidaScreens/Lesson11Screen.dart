...
import 'package:quranapp/controllers/lesson11_controller.dart';
...
class Lesson11Screen extends StatefulWidget {
  ...
  const Lesson11Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson11ScreenState extends State<Lesson11Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson11Controller());
    sounds = FirebaseApi.listAll('sound11/');
    files = FirebaseApi.listAll('text11/');
    instructions = FirebaseApi.listAll('instruction11/');
  ...
  @override
  void dispose() {
    Get.find<Lesson11Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 0,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction11%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text11%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                    ...
                                    word:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text11%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    soundPath:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound11%2FL11%20${index + 1}.wav?alt=media&token=48076475-9d3a-403f-8d63-c7e407fc6479");
                              },
                              childCount: 79,
                            ),
                            gridDelegate:
