...
import 'package:quranapp/controllers/lesson22_controller.dart';
...
class Lesson22Screen extends StatefulWidget {
  ...
  const Lesson22Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson22ScreenState extends State<Lesson22Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson22Controller());
    sounds = FirebaseApi.listAll('sound22/');
    files = FirebaseApi.listAll('text22/');
    instructions = FirebaseApi.listAll('instruction22/');
  ...
  @override
  void dispose() {
    Get.find<Lesson22Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 4,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction22%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text22%2F1.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                                  ],
                                ),
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                  ...
                                  word:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text22%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                  soundPath:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound22%2F${index + 1}.wav?alt=media&token=2ccb240a-4e4f-4a91-8f6a-df6932899852",
                                );
                              },
                              childCount: 3,
                            ),
