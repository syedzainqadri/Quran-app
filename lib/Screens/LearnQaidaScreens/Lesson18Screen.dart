...
class Lesson18Screen extends StatefulWidget {
  ...
  const Lesson18Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson18ScreenState extends State<Lesson18Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson18Controller());
    sounds = FirebaseApi.listAll('sound18/');
    files = FirebaseApi.listAll('text18/');
    instructions = FirebaseApi.listAll('instruction18/');
  ...
  @override
  void dispose() {
    Get.find<Lesson18Controller>().dispose();
    super.dispose();
  }
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text18%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                  ...
                                  soundPath:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound18%2F${index + 1}.wav?alt=media&token=2ccb240a-4e4f-4a91-8f6a-df6932899852",
                                );
                              },
                              childCount: 1,
                            ),
