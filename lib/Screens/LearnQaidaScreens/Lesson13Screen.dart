...
import 'package:quranapp/controllers/lesson13_controller.dart';
...
class Lesson13Screen extends StatefulWidget {
  ...
  const Lesson13Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson13ScreenState extends State<Lesson13Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson13Controller());
    sounds = FirebaseApi.listAll('sound13/');
    files = FirebaseApi.listAll('text13/');
    instructions = FirebaseApi.listAll('instruction13/');
  ...
  @override
  void dispose() {
    Get.find<Lesson13Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 3,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction13%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text13%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                    ...
                                    word:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text13%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    soundPath:
                                        "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound13%2FL13%20${index + 1}.wav?alt=media&token=48076475-9d3a-403f-8d63-c7e407fc6479");
                              },
                              childCount: 12,
                            ),
                            gridDelegate:
