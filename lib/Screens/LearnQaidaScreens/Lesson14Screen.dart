...
import 'package:quranapp/controllers/lesson14_controller.dart';
...
class Lesson14Screen extends StatefulWidget {
  ...
  const Lesson14Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson14ScreenState extends State<Lesson14Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson14Controller());
    sounds = FirebaseApi.listAll('sound14/');
    files = FirebaseApi.listAll('text14/');
    instructions = FirebaseApi.listAll('instruction14/');
  ...
  @override
  void dispose() {
    Get.find<Lesson14Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 1,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction14%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text14%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                  ...
                                  word:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text14%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                  soundPath:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound14%2F${index + 1}.wav?alt=media&token=2ccb240a-4e4f-4a91-8f6a-df6932899852",
                                );
                              },
                              childCount: 64,
                            ),
