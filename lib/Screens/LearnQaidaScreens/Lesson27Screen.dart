...
import 'package:quranapp/controllers/lesson27_controller.dart';
...
class Lesson27Screen extends StatefulWidget {
  ...
  const Lesson27Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson27ScreenState extends State<Lesson27Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson27Controller());
    sounds = FirebaseApi.listAll('sound27/');
    files = FirebaseApi.listAll('text27/');
    instructions = FirebaseApi.listAll('instruction27/');
  ...
  @override
  void dispose() {
    Get.find<Lesson27Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 21,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction27%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text27%2F0.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                  ...
                                  word:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text27%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                  soundPath:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound27%2F${index + 1}.wav?alt=media&token=2ccb240a-4e4f-4a91-8f6a-df6932899852",
                                );
                              },
                              childCount: 34,
                            ),
