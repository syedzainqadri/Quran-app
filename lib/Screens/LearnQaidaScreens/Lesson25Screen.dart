...
import 'package:quranapp/controllers/lesson25_controller.dart';
...
class Lesson25Screen extends StatefulWidget {
  ...
  const Lesson25Screen({Key key, this.lessonModel}) : super(key: key);
...
class _Lesson25ScreenState extends State<Lesson25Screen> {
  ...
  void initState() {
    ...
    Get.put(Lesson25Controller());
    sounds = FirebaseApi.listAll('sound25/');
    files = FirebaseApi.listAll('text25/');
    instructions = FirebaseApi.listAll('instruction25/');
  ...
  @override
  void dispose() {
    Get.find<Lesson25Controller>().dispose();
    super.dispose();
  }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  showInstructionDialog(
                      ...
                      itemLength: 5,
                      url:
                          "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/instruction25%2Fi");
                },
              ),
              body: FutureBuilder(
                              ...
                              background: MyFlexibleAppBar(
                                ...
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    SvgPicture.network(
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text25%2F1.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                    ),
                                    // Text(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return CustomWordCard(
                                  ...
                                  word:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/text25%2F${index + 1}.svg?alt=media&token=895c9ad1-c1e4-4935-a353-002fa55fdee4",
                                  soundPath:
                                      "https://firebasestorage.googleapis.com/v0/b/shafique-academy.appspot.com/o/sound25%2F${index + 1}.wav?alt=media&token=2ccb240a-4e4f-4a91-8f6a-df6932899852",
                                );
                              },
                              childCount: 4,
                            ),
